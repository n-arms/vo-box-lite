...
def write_confirm_module(light_tree, dark_tree, out_path):
    ...
    out.write("/* fast12_cardinal_trees.rs -- GENERATED by gen_fast12_scalar.py "
              "--confirm-out (do not edit). 8 pattern trees for the SIMD\n")
    out.write(" * 3-of-4-cardinal confirm (fast.rs::ee), 4th cardinal free, trained\n")
    out.write(" * on exhaustive 2^13 configs. Regenerate: gen_fast12_scalar.py --confirm-out. */\n\n")
    for r in (0, 4, 8, 12):
